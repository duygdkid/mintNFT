...
(async () => {
    try {
        const totalNfts = 100; //Total NFTs you are going to mint, for example : 10k

        console.log('Running bulk_mint_nfts script...');

        const contractName = 'ArtCollectibleV2'; // Name of your contract, change this for other contract
        
        //the contract address, you get this after deploying "ArtCollectibleV2" on http://remix.ethereum.org
        const contract_address = '0xde7334A22028157a0180A77A3aFD36c9B7D0720D'; 
